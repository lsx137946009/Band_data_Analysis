# -*- coding: utf-8 -*-
"""
Created on Sat Jun 27 16:10:30 2020
...
class _SensorRRI(SensorSeries):
    ...
    def time_domain(rri):
        ...
        nn50 = _SensorRRI._nn50(rri)
        pnn50 = _SensorRRI._pnn50(rri)
        mrri = np.mean(rri)
    ...
    @staticmethod
    def _pnn50(rri):
        return _SensorRRI._nn50(rri) / len(rri) * 100
    ...
    def frequency_domain(
        ...
        **kwargs
        ...
        return _SensorRRI._auc(fxx, pxx, vlf_band, lf_band, hf_band)
    ...
    def non_linear(rri):
        ...
        """
        sd1, sd2 = _SensorRRI._poincare(rri)
